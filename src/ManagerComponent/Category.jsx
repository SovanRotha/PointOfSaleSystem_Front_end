    ...
    <div className="min-h-screen bg-[#F8FAFC] p-6 space-y-6">
        ...
        <div className="flex items-center gap-4 self-end sm:self-auto">
          ...
          <div className="flex items-center gap-3 border-l border-slate-200 pl-4">
            <div className="text-right hidden sm:block">
              <p className="text-xs font-bold text-slate-800">manager User</p>
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <div className="flex gap-1.5">
            <button
        onClick = {() => navigate("/manager/menu/modifier")}
        ...
        <button
          onClick={() => navigate("/manager/menu/addCategory")}
          className="flex items-center justify-center gap-2 bg-[#002B7F] hover:bg-blue-900 text-white font-semibold px-5 py-2.5 rounded-xl text-sm shadow-sm transition-all"
        >
          ...
          <div  className="lg:col-span-3 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
            {filteredCategories.map((category) => {
              ...
              return (
                <div
                  key={category.id}
                  onClick={()=>navigate(`/manager/menu/menuItem/${category.id}`)}
                    ...
                    <div className="flex items-start justify-between mb-3">
                      ...
                      <div className="flex items-center gap-1">
                        <button
                          onClick={() =>
                            navigate(
                              `/manager/menu/editCategory/${category.id}`
                            )
                          }
